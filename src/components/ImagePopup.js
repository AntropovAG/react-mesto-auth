...
function ImagePopup({cardAttributes, onClose}) {
  ...
  return (
    <section className={`popup popup_background_dark popup_type_view-image ${cardAttributes.link && 'popup_opened'}`} onMouseDown={handleOverlayClick}>
